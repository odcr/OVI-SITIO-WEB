...
contexto.beginPath();contexto.fillStyle =colorB;contexto.arc(parseInt(panelWords(coorx[texSel])),parseInt(panelWords(coory[texSel])),3, 0 , 2 * Math.PI, false);
contexto.fill();contexto.strokeStyle = colorL;contexto.lineWidth = 2;contexto.stroke();}
function isCorrect(cell){
var totalCorrect=0;var solu=$(cell).children("div.txtCell_txt").text();if (answers[texSel].replace("&#39;","'")==solu){
